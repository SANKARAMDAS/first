...
import './BusinessWalletPayment.css'
import $ from 'jquery'
import 'jquery-ui-dist/jquery-ui'


const BusinessWalletPayment = (props) => {
          ...
          <Row>
              ...
              <div className="box-1">
                <div className="row">
                  <div className="tab active">
                    {/* <img src={bitcoinimg} alt="bit-coin-img" />  */}
                    Bitcoin
                  </div>
            ...
            <Col>
              <div className="box-1">
                <div className="row">
                  <div className="tab active">
                    {/* <img src={ethcoinimg} alt="eth-coin-img" />  */}
                    Ethereum
                  </div>
                  <div className="col-sm-8">
...
export default BusinessWalletPayment
